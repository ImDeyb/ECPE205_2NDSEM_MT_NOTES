...
import java.awt.event.ActionListener;
    ...
    public class EmailPanel extends JPanel {
        ...
        private void init() {
            ...
            add(radioButtons = new JPanel(new FlowLayout(FlowLayout.LEFT)), 0, 5, 3, 1, 0, 0, GridBagConstraints.HORIZONTAL);

            radioButtons.add(htmlRbtn = new JRadioButton("HTML"));
            radioButtons.add(plainTxtRBtn = new JRadioButton("Plain Text"));
            radioButtons.add(customRbtn = new JRadioButton("Custom"));

            buttonGroup = new ButtonGroup();

            buttonGroup.add(htmlRbtn);
            buttonGroup.add(plainTxtRBtn);
            buttonGroup.add(customRbtn);
        ...
        private void addEmailAddress() {
            ...
            if(!emails.isEmpty()) {
                if(listModel.contains(emails) == true) {
