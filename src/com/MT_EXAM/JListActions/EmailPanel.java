...
import java.awt.event.ActionListener;
    ...
    public class EmailPanel extends JPanel {
        ...
        private void init() {
            ...
            add(emailField = new JTextField(15),1,0,3,1,1,1,GridBagConstraints.HORIZONTAL);
            ...
            add(buttonPanel = new JPanel(new FlowLayout(FlowLayout.LEFT)), 0, 5, 3, 1, 0, 0, GridBagConstraints.HORIZONTAL);
            buttonPanel.add(htmlRbtn);
            buttonPanel.add(plainTxtRBtn);
            buttonPanel.add(customRbtn);
